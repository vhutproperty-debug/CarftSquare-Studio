# Invariants-only — pr-1785168091942
...
- [x] friendly_waf_page_goto_net_ERR_HTTP: in=page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at https://ww… out=Portal blocked this login page (security / WAF). Retry later or from a trusted network.
- [x] friendly_waf_Connect_navigation_block: in=Connect navigation blocked before login surface (portal=magi… out=Portal blocked this login page (security / WAF). Retry later or from a trusted network.
