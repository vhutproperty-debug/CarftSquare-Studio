...
import type { OpsDealActivity } from '@/lib/ops/deals/types';
...
export default function DealTimeline({ activities }: { activities: OpsDealActivity[] }) {
        ...
        <li key={activity.id} className="rounded-lg border border-slate-100 bg-slate-50 px-3 py-2.5">
          <div className="flex flex-wrap items-baseline justify-between gap-2">
            <p className="text-xs font-bold uppercase tracking-wide text-slate-500">
              {DEAL_ACTIVITY_LABELS[activity.type]}
            </p>
