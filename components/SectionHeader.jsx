...
export default function SectionHeader({ eyebrow, title, text, light = false, headingId }) {
  return (
    <div className="mx-auto mb-10 max-w-3xl text-center">
      ...
      <h2 id={headingId} className={`text-3xl font-black tracking-tight md:text-5xl ${light ? 'text-white' : 'text-slate-950'}`} style={{ fontFamily: "'Cormorant Garamond', serif" }}>{title}</h2>
