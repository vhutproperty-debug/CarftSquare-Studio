...
export default function DemandWorkspace() {
  ...
  useEffect(() => {
    setPage(1);
  }, [debouncedSearch, filters.source, filters.status, filters.priority, filters.assignedTo, filters.rentBuy, filters.project, filters.building, filters.dateFrom, filters.dateTo, filters.mineOnly, filters.followUpToday, filters.overdueOnly]);
